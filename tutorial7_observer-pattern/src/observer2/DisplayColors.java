...
//        slider.addChangeListener(this);
    ...
    protected OriginalColorPanel createOriginalColorPanel(Color initialColor) {
        OriginalColorPanel originalColorPanel = new OriginalColorPanel(initialColor);
    ...
    protected ComplementaryColorPanel createComplementaryColorPanel(Color initialColor) {
        ComplementaryColorPanel complementaryColorPanel = new ComplementaryColorPanel(initialColor);
